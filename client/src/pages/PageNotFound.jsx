    ...
    <div className="flex flex-col items-center justify-center text-sm h-[400px]">
      ...
      <div className="flex items-center gap-4 mt-6">
        <button
          type="button"
          onClick={() => navigate("/")}
          className="bg-primary hover:bg-hover px-7 py-2.5 text-white rounded-lg active:scale-95 transition-all cursor-pointer"
        >
          Go back home
        </button>
        <button
          ...
          className="group flex items-center gap-2 px-7 py-2.5 active:scale-95 transition cursor-pointer"
        >
          Contact support
          <svg
